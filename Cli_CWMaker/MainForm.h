...
namespace CliCWMaker
{
	...
	/// <summary>
	/// Îñíîâíîé êëàññ ïğèëîæåíèÿ
	/// </summary>
	public ref class MainForm : public Form
	{
		// àáñòğàêòíûé óêàçàòåëü êîìïîíåíòà Strategy èíêàïñóëÿöèÿ ëîãèêè ïğèëîæåíèÿ
		// ïğèìåğ êîìïîçèöèè. êëàññ MainForm ïîëíîñòüş óïğàâëÿåò æèçíåííûì öèêëîì
		// ğåàëèçàöèè êëàññà IStrategy
		IStrategy^ strategy;
...
#pragma endregion
	...
	public:
		...
		MainForm()
		{
			InitializeComponent();          // èíèöèàëèçàöèÿ êîìïîíåíòîâ ôîğìû
			strategy = gcnew CWStrategy();  // ñîçäàíèå ıêçåìïëÿğà ñòğàòåãèè
			strategy->setObject(this);      // óñòàíîâêà îáúåêòà ìàíèïóëèğîâàíèÿ
		}


	// Çàêğûòûå ìåòîäû êëàññà
	private: void InitializeComponent(void)
	{
		...
		this->toolStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(7)
		{
			this->ñîçäàòüToolStripButton,
				this->îòêğûòüToolStripButton, this->ñîõğàíèòüToolStripButton, this->ïå÷àòüToolStripButton, this->bConsole, this->bCutWords, this->ñïğàâêàToolStripButton
		});
		...
		this->ñîçäàòüToolStripButton->ToolTipText = L"Ñîçäàòü íîâûé êğîññâîğä";
		...
		this->îòêğûòüToolStripButton->Visible = false;
		// 
		...
		this->ñîõğàíèòüToolStripButton->Visible = false;
		// 
		...
		this->ïå÷àòüToolStripButton->Text = L"Ïğåäïğîñìîòğ";
		this->ïå÷àòüToolStripButton->ToolTipText = L"Ïğåäïğîñìîòğ è ïå÷àòü";
		...
		this->bConsole->Text = L"Ïğåäïğîñìîòğ (êîíñîëü)";
		this->bConsole->ToolTipText = L"Ïğåäïğîñìîòğ â êîíñîëè";
		...
		this->bCutWords->Text = L"ÊÀĞÊÀÑ";
		this->bCutWords->ToolTipText = L"Óáğàòü ñëîâà èç ñåòêè êğîññâîğäà";
		this->bCutWords->Click += gcnew System::EventHandler(this, &MainForm::bCutWords_Click);
		// 
		// ñïğàâêàToolStripButton
		// 
		this->ñïğàâêàToolStripButton->AutoToolTip = false;
		...
		this->ñïğàâêàToolStripButton->Size = System::Drawing::Size(102, 22);
		this->ñïğàâêàToolStripButton->Text = L"Î ïğ&îãğàììå";
		this->ñïğàâêàToolStripButton->ToolTipText = L"Ïğîñìîòğåòü ñïğàâêó";
		this->ñïğàâêàToolStripButton->Click += gcnew System::EventHandler(this, &MainForm::ñïğàâêàToolStripButton_Click);
		// 
		// tabControl1
		// 
		...
		this->tabPage2->Text = L"Ğåçóëüòàò";
		// 
		// groupBox2
		// 
		...
		this->groupBox2->Text = L"Ñëîâà ïî ãîğèçîíòàëè:";
		// 
		// tbHorizontal
		// 
		...
		this->groupBox1->Text = L"Ñëîâà ïî âåğòèêàëè:";
		// 
		// tbVertical
		// 
